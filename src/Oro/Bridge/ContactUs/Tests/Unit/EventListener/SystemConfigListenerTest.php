...
use Oro\Bridge\ContactUs\EventListener\SystemConfigListener;
...
class SystemConfigListenerTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $id = 42;
        $key = 'oro_contact_us_bridge___consent_contact_reason';
    ...
    {
        $id = 42;
        $key = 'oro_contact_us_bridge.consent_contact_reason';
