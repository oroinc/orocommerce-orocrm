...
Feature: Export Customers
  ...
  Scenario: Export Customers
    ...
    And Exported file for "Customers" contains the following data:
      | Id  | Name                       |  Parent Id   |  Group Name         | Tax code   | Account                    | Internal rating Id | Payment term Label |
      |  1  | Company A                  |              | All Customers       | Tax_code_1 | Company A                  | 2_of_5             |        net 30      |
      |  2  | Company A - East Division  |  1           | All Customers       | Tax_code_1 | Company A - East Division  | 1_of_5             |        net 90      |
      |  3  | Company A - West Division  |  1           | All Customers       | Tax_code_1 | Company A - West Division  | 1_of_5             |        net 60      |
